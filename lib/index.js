...
var ReactCurrencySelect = function (_Component) {
    _inherits(ReactCurrencySelect, _Component);

    function ReactCurrencySelect(props) {
        _classCallCheck(this, ReactCurrencySelect);
    ...
    ReactCurrencySelect.prototype.toggleOptions = function toggleOptions() {
        !this.state.disabled && this.setState({
            openOptions: !this.state.openOptions
        });
    };

    ReactCurrencySelect.prototype.closeOptions = function closeOptions(event) {
    ...
    ReactCurrencySelect.prototype.onSelect = function onSelect(countryCode) {
        this.setState({
    ...
    ReactCurrencySelect.prototype.updateSelected = function updateSelected(countryCode) {
    ...
    ReactCurrencySelect.prototype.filterSearch = function filterSearch(evt) {
        var _this2 = this;
    ...
    ReactCurrencySelect.prototype.componentDidMount = function componentDidMount() {
        !this.props.disabled && window.addEventListener("click", this.closeOptions);
    };

    ReactCurrencySelect.prototype.componentWillUnmount = function componentWillUnmount() {
        !this.props.disabled && window.removeEventListener("click", this.closeOptions);
    };

    ReactCurrencySelect.prototype.render = function render() {
        var _this3 = this;
        ...
        return _react2.default.createElement(
            'div',
            { className: 'flag-select ' + (this.props.className ? this.props.className : ""), style: { color: '' + selectedColor } },
    ...
    return ReactCurrencySelect;
}(_react.Component);

ReactCurrencySelect.defaultProps = {
    selectedSize: 16,
    optionsSize: 14,
...
exports.default = ReactCurrencySelect;
